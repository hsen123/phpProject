    ...
    function build(opts) {
                    ...
                    if (selector[0] != '@' && matchesSelector(node, selector)) {
                        ...
                        if (styles != null) {
                            for (var name in styles) {
                                var existingSpecificity = this
                                    .stylesSpecificity[name];
                ...
                for (var i = 0; i < this.attributesToInherit.length; i++) {
                    ...
                    if (
                        ...
                        this.attribute(
                            attributeToInherit,
                            true,
                        ).value = stopsContainer.attribute(
                            attributeToInherit,
                        ).value;
                    }
                }
            ...
            this.createGradient = function(ctx, element, parentOpacityProp) {
                ...
                if (g == null)
                    return addParentOpacity(
                        stopsContainer.stops[stopsContainer.stops.length - 1]
                            .color,
                    );
        ...
        svg.Element.text = function(node) {
            ...
            this.setContext = function(ctx) {
                ...
                var textBaseline = this.style(
                    'dominant-baseline',
                ).toTextBaseline();
                if (textBaseline == null)
                    textBaseline = this.style(
                        'alignment-baseline',
                    ).toTextBaseline();
        ...
        svg.Element.TextElementBase = function(node) {
            ...
            this.renderChildren = function(ctx) {
                ...
                if (ctx.paintOrder == 'stroke') {
                    ...
                    if (ctx.fillStyle != '')
                        ctx.font = '12px VerdanaPro-Regular';
                    ctx.fillText(
                        svg.compressSpaces(this.getText()),
                        this.x,
                        this.y,
